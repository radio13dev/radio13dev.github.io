function createUnityInstance(r, t, l) {
    function d(e, r) {
        if (!d.aborted && t.showBanner)
            return "error" == r && (d.aborted = !0), t.showBanner(e, r);
        switch (r) {
        case "error":
            console.error(e);
            break;
    ...
    function n(e) {
        ...
        (t += "\n" + (n = n.startsWith(t) ? n.substring(t.length) : n).trim()) &&
        g.stackTraceRegExp && g.stackTraceRegExp.test(t) &&
        f(t, e.filename || r && (r.fileName || r.sourceURL) || "",
            e.lineno || r &&
            (r.lineNumber || r.line) || 0)
    }

    function e(e, r, t) {
        var n = e[r];
        void 0 !== n && n ||
        (console.warn('Config option "' + r + '" is missing or empty. Falling back to default value: "' + t + '". Consider updating your WebGL template to include the missing config option.'), e[r] = t)
    }
    l = l || function () {};
    var o,
    g = {
    ...
    for (o in e(t, "companyName", "Unity"), e(t, "productName", "WebGL Player"), e(t, "productVersion", "1.0"), t)
        g[o] = t[o];
    g.streamingAssetsUrl = new URL(g.streamingAssetsUrl, buildUrl).href;
    var i = g.disabledCanvasEvents.slice();
    function a(e) {
        e.preventDefault()
    }
    ...
    //u = "";
    //function c(e) {
    //    document.webkitCurrentFullScreenElement === r ? r.style.width && (s = r.style.width, u = r.style.height, r.style.width = "100%", r.style.height = "100%") : s && (r.style.width = s, r.style.height = u, u = s = "")
    //}
    //document.addEventListener("webkitfullscreenchange", c),
    //g.deinitializers.push(function () {
    //    for (var e in g.disableAccessToMediaDevices(), i.forEach(function (e) {
    //            r.removeEventListener(e, a)
    //        }), window.removeEventListener("error", n), window.removeEventListener("unhandledrejection", n), document.removeEventListener("webkitfullscreenchange", c), g.intervals)
    //        window.clearInterval(e);
    //    g.intervals = {}
    //}),
    g.QuitCleanup = function () {
        for (var e = 0; e < g.deinitializers.length; e++)
            g.deinitializers[e]();
        g.deinitializers = [],
        "function" == typeof g.onQuit && g.onQuit()
    };
    var h = {
        Module: g,
        SetFullscreen: function () {
            if (g.SetFullscreen)
                return g.SetFullscreen.apply(g, arguments);
            g.print("Failed to set Fullscreen mode: Player not loaded yet.")
        },
        SendMessage: function () {
            if (g.SendMessage)
                return g.SendMessage.apply(g, arguments);
            g.print("Failed to execute SendMessage: Player not loaded yet.")
        },
        ConnectToProfiler: function () {
            if (g.ConnectToProfiler)
                return g.ConnectToProfiler.apply(g, arguments);
            g.print("Failed to execute ConnectToProfiler: Player not loaded yet.")
        },
        StopProfiling: function () {
            if (g.StopProfiling)
                return g.StopProfiling.apply(g, arguments);
            g.print("Failed to execute StopProfiling: Player not loaded yet.")
        },
        IsConnectedToProfiler: function () {
            if (g.IsConnectedToProfiler)
                return g.IsConnectedToProfiler.apply(g, arguments);
            g.print("Failed to execute IsConnectedToProfiler: Player not loaded yet.")
        },
        Quit: function () {
        ...
        GetMetricsInfo: function () {
            var e = Number(g._getMetricsInfo()) >>> 0,
            r = 4 + e,
            t = 4 + r,
            n = 8 + t,
            o = 8 + n,
            ...
            c = 4 + u;
            return {
                totalWASMHeapSize: g.HEAPU32[e >> 2],
                usedWASMHeapSize: g.HEAPU32[r >> 2],
                totalJSHeapSize: g.HEAPF64[t >> 3],
                usedJSHeapSize: g.HEAPF64[n >> 3],
                pageLoadTime: g.HEAPU32[o >> 2],
                pageLoadTimeToFrame1: g.HEAPU32[i >> 2],
                fps: g.HEAPF64[a >> 3],
                movingAverageFps: g.HEAPF64[s >> 3],
                assetLoadTime: g.HEAPU32[l >> 2],
                webAssemblyStartupTime: g.HEAPU32[d >> 2] - (g.webAssemblyTimeStart || 0),
                codeDownloadTime: g.HEAPU32[u >> 2],
                gameStartupTime: g.HEAPU32[c >> 2],
                numJankedFrames: g.HEAPU32[4 + c >> 2]
            }
        }
    };
    function f(e, r, t) {
        -1 == e.indexOf("fullscreen error") && (g.startupErrorHandler ? g.startupErrorHandler(e, r, t) : g.errorHandler && g.errorHandler(e, r, t) || (console.log("Invoking error handler due to\n" + e), "function" == typeof dump && dump("Invoking error handler due to\n" + e), f.didShowErrorMessage || (-1 != (e = "An error occurred running the Unity content on this page. See your browser JavaScript console for more info. The error was:\n" + e).indexOf("DISABLE_EXCEPTION_CATCHING") ? e = "An exception has occurred, but exception handling has been disabled in this build. If you are the developer of this content, enable exceptions in your project WebGL player settings to be able to catch the exception or see the stack trace." : -1 != e.indexOf("Cannot enlarge memory arrays") ? e = "Out of memory. If you are the developer of this content, try allocating more memory to your WebGL build in the WebGL player settings." : -1 == e.indexOf("Invalid array buffer length") && -1 == e.indexOf("Invalid typed array length") && -1 == e.indexOf("out of memory") && -1 == e.indexOf("could not allocate memory") || (e = "The browser could not allocate enough memory for the WebGL content. If you are the developer of this content, try allocating less memory to your WebGL build in the WebGL player settings."), alert(e), f.didShowErrorMessage = !0)))
    }
    function m(e, r) {
        if ("symbolsUrl" != e) {
            var t = g.downloadProgress[e],
            n = (t = t || (g.downloadProgress[e] = {
                            started: !1,
                            finished: !1,
                            lengthComputable: !1,
                            total: 0,
                            loaded: 0
                        }), "object" != typeof r || "progress" != r.type && "load" != r.type || (t.started || (t.started = !0, t.lengthComputable = r.lengthComputable), t.total = r.total, t.loaded = r.loaded, "load" == r.type && (t.finished = !0)), 0),
            o = 0,
            i = 0,
            a = 0,
            s = 0;
            for (e in g.downloadProgress) {
                if (!(t = g.downloadProgress[e]).started)
                    return;
                i++,
                t.lengthComputable ? (n += t.loaded, o += t.total, a++) : t.finished || s++
            }
    ...
    g.readBodyWithProgress = function (i, a, s) {
        ...
        d = function (e, r) {
            ...
            switch (r) {
            case "br":
                return Math.min(Math.round(2 * t), n);
            case "gzip":
                return Math.min(Math.round(1.6 * t), n);
            default:
                return t
            }
        }
        ...
        function o() {
            return void 0 === e ? i.arrayBuffer().then(function (e) {
                ...
                if (e.done) {
                    ...
                    if (h < d)
                        return u.slice(0, h);
                    for (var r = new Uint8Array(h), t = (r.set(u, 0), f), n = 0; n < c.length; ++n)
                        r.set(c[n], t), t += c[n].length;
                    return r
                }
                return h + e.value.length <= u.length ? (u.set(e.value, h), f = h + e.value.length) : c.push(e.value),
                h += e.value.length,
                a({
                    type: "progress",
                    response: i,
    ...
    g.fetchWithProgress = function (e, r) {
        var t = function () {};
        return r && r.onProgress && (t = r.onProgress),
        fetch(e, r).then(function (e) {
            return g.readBodyWithProgress(e, t, r.enableStreamingDownload)
        })
    };
    var b = {
        gzip: {
            hasUnityMarker: function (e) {
                ...
                if (r > e.length || 31 != e[0] || 139 != e[1])
                    return !1;
                var n = e[3];
                if (4 & n) {
                    if (r + 2 > e.length)
                        return !1;
                    if ((r += 2 + e[r] + (e[r + 1] << 8)) > e.length)
                        return !1
                }
                if (8 & n) {
                    for (; r < e.length && e[r]; )
                ...
                return 16 & n && String.fromCharCode.apply(null, e.subarray(r, r + t.length + 1)) == t + "\0"
            }
        },
        br: {
            hasUnityMarker: function (e) {
                ...
                if (commentOffset = 1 + t + 2 + 1 + 2 + (o << 3) + 7 >> 3, 17 == n || commentOffset > e.length)
                    return !1;
                for (var i = n + (6 + (o << 4) + (r.length - 1 << 6) << t), a = 0; a < commentOffset; a++, i >>>= 8)
                    if (e[a] != (255 & i))
                        return !1;
                return String.fromCharCode.apply(null, e.subarray(commentOffset, commentOffset + r.length)) == r
            }
        }
    };
    function p() {
        ...
        p = (new Promise(function (i, e) {
                ...
                e(g),
                g.codeDownloadTimeEnd = performance.now() - n
            }), performance.now()),
        o = (m(r = "dataUrl"), e = g.fetchWithProgress, s = g[r], t = /file:\/\//.exec(s) ? "same-origin" : void 0, e(g[r], {
                method: "GET",
        ...
        g.preRun.push(function () {
            g.addRunDependency("dataUrl"),
            o.then(function (r) {
                var e = new TextDecoder("utf-8"),
                t = 0;
                function n() {
                    var e = (r[t] | r[t + 1] << 8 | r[t + 2] << 16 | r[t + 3] << 24) >>> 0;
                    return t += 4,
                    e
                }
                function o(e) {
                    if (b.gzip.hasUnityMarker(r))
                ...
                a = e.decode(r.subarray(0, i.length)),
                s = (a != i && o('Unknown data format (id="' + a + '")'), t += i.length, n());
                for (t + s > r.length && o("Invalid binary data file header! (pos=" + t + ", headerSize=" + s + ", file length=" + r.length + ")"); t < s; ) {
                    var l = n(),
                    d = n(),
                    u = (l + d > r.length && o("Invalid binary data file size! (offset=" + l + ", size=" + d + ", file length=" + r.length + ")"), n()),
                    c = (t + u > r.length && o("Invalid binary data file path name! (pos=" + t + ", length=" + u + ", file length=" + r.length + ")"), e.decode(r.subarray(t, t + u)));
                    t += u;
                    for (var h = 0, f = c.indexOf("/", h) + 1; 0 < f; h = f, f = c.indexOf("/", h) + 1)
                        g.FS_createPath(c.substring(0, h), c.substring(h, f - 1), !0, !0);
                    g.FS_createDataFile(c, null, r.subarray(l, l + d), !0, !0, !0)
                }
                g.removeRunDependency("dataUrl"),
                g.dataUrlLoadEndTime = performance.now() - p
            })
        })
    }
    return new Promise(function (e, r) {
        var t;
        g.SystemInfo.hasWebGL ? 1 == g.SystemInfo.hasWebGL ? (t = 'Your browser does not support graphics API "WebGL 2" which is required for this content.', "Safari" == g.SystemInfo.browser && parseInt(g.SystemInfo.browserVersion) < 15 && (g.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? t += "\nUpgrade to iOS 15 or later." : t += "\nUpgrade to Safari 15 or later."), r(t)) : g.SystemInfo.hasWasm ? g.SystemInfo.hasWasm2023 ? (g.startupErrorHandler = r, l(0), g.postRun.push(function () {
                l(1),
                g.WebPlayer.WaitForInitialization().then(function () {
                    delete g.startupErrorHandler,
                    e(h),
                    g.pageStartupTime = performance.now()
                })
            }), new Promise(function (r, e) {
                navigator.gpu ? navigator.gpu.requestAdapter().then(function (e) {
                    g.SystemInfo.hasWebGPU = !!e,
                    r(g.SystemInfo.hasWebGPU)
                }) : r(!1)
            }).then(function () {
                p()
            })) : r("Your browser does not support WebAssembly 2023. Please update to Chrome \u2265 91 (May 2021), Firefox \u2265 89 (June 2021) or Safari \u2265 16.4 (March 2023). (failed " + g.SystemInfo.missingWasm2023Feature + ")") : r("Your browser does not support WebAssembly.") : r("Your browser does not support WebGL.")
    })
}
